...
function addCartButton(item, slug, name, price) {
    ...
    // Insertar botón después del precio
...
function setupClickableItem(item, slug) {
    ...
    item.addEventListener('click', function (e) {
        // Evitar navegación si se hace clic en el botón de carrito
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Inicializar barra de navegación de vistas solo si está habilitada
    if (restaurantConfig.navBar === 1 && typeof BottomNav !== 'undefined') {
        window.bottomNav = new BottomNav();
        window.bottomNav.mount();
    }
});